...
export default function PrivacyPolicy() {
  ...
  return (
    <div>
      <Helmet>
        <title>Privacy Policy - Firefly Tiny Homes</title>
        <meta name="description" content="Firefly Tiny Homes Privacy Policy - How we collect, use, and protect your information." />
      </Helmet>

      <div className="max-w-4xl mx-auto py-12 px-4">
        <h1 className="text-4xl font-bold text-gray-100 mb-8">{policy?.title || 'Privacy Policy'}</h1>
