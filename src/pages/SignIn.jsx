		...
		<>
			...
			<div className="min-h-screen p-4 pt-20 md:pt-4 relative">
				<div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-md px-4">
					...
					<h1 className="text-2xl font-bold text-white text-center mb-3">Welcome Back</h1>
					<p className="text-gray-300 text-center mb-8">Sign in to your Firefly Tiny Homes account</p>
