...
export default function Home() {
  ...
  const siteJsonLd = { "@context":"https://schema.org","@type":"WebSite","url":"https://fireflyestimator.com","name":"Firefly Tiny Homes","potentialAction":{"@type":"SearchAction","target":"https://fireflyestimator.com/search?q={query}","query-input":"required name=query"}}
  const faqJsonLd = { "@context":"https://schema.org","@type":"FAQPage","mainEntity":[
    { "@type":"Question","name":"Are Firefly’s homes park model RVs in Texas?","acceptedAnswer":{"@type":"Answer","text":"Yes—our park model homes are classified as RVs in Texas and delivered factory-direct to your site."}},
    { "@type":"Question","name":"Can I really order in under an hour?","acceptedAnswer":{"@type":"Answer","text":"Best-case, yes. Most buyers complete pre-approval and e-sign quickly; documentation needs can vary."}},
    { "@type":"Question","name":"Do you offer financing?","acceptedAnswer":{"@type":"Answer","text":"Yes—modern, online financing with soft-pull pre-qualification to view offers fast."}},
    { "@type":"Question","name":"Where do you deliver?","acceptedAnswer":{"@type":"Answer","text":"Statewide across Texas; we help coordinate site readiness and setup."}},
    { "@type":"Question","name":"Can I customize my layout?","acceptedAnswer":{"@type":"Answer","text":"Absolutely—our design studio lets you select finishes and options with live pricing."}}
  ]}
