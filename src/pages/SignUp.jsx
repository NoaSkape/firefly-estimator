		...
		<>
			...
			<div className="min-h-screen p-4 pt-20 md:pt-4 relative">
				<div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-md px-4">
					<div className="w-16 h-16 bg-white rounded-lg flex items-center justify-center shadow-lg overflow-hidden mx-auto mb-6 mt-[7px] md:mt-0">
						<img 
							src="/app-icon.png" 
					...
					<h1 className="text-2xl font-bold text-white text-center mb-3">Create Your Firefly Account</h1>
					<p className="text-gray-300 text-center mb-8">To save your customizations and calculate delivery costs</p>
