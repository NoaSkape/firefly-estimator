      ...
      <div className="min-h-screen flex items-center justify-center p-4 pt-20 md:pt-4 relative">
        <div className="w-full max-w-md">
          <div className="text-center mb-8 relative">
            ...
            <p className="text-gray-300 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 mt-32">To save your customizations and calculate delivery costs</p>
          </div>
