      ...
      <div className="min-h-screen flex items-center justify-center p-4 pt-20 md:pt-4 relative">
        <div className="w-full max-w-md">
          <div className="text-center mb-8 relative">
            <div className="w-16 h-16 bg-white rounded-lg flex items-center justify-center shadow-lg overflow-hidden mx-auto mb-6 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 -mt-32">
              <img 
                src="/app-icon.png" 
            ...
            <h1 className="text-2xl font-bold text-white mb-3 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 -mt-16">Create Your Firefly Account</h1>
            <p className="text-gray-300 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 -mt-8">To save your customizations and calculate delivery costs</p>
          </div>
