  ...
  try {
    ...
    const page1HTML = `
      <div style="position: relative; margin-bottom: 30px;">
        <img src="/logo/firefly-logo.png" alt="Firefly Tiny Homes" style="height: 60px; position: absolute; top: -50px; left: 0;"/>
        <div style="text-align: right; font-size: 14px; color: #000000; position: absolute; top: -40px; right: 0;">Page 1</div>
        <div style="text-align: center; margin-top: 30px; border-bottom: 2px solid #f59e0b; padding-bottom: 20px;">
    ...
    const page2HTML = `
      <div style="position: relative; margin-bottom: 30px;">
        <img src="/logo/firefly-logo.png" alt="Firefly Tiny Homes" style="height: 60px; position: absolute; top: -50px; left: 0;"/>
        <div style="text-align: right; font-size: 14px; color: #000000; position: absolute; top: -40px; right: 0;">Page 2</div>
      </div>
