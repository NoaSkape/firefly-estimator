        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <AnimatedSection animation="slideInLeft" delay={400}>
              <HoverCard className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-700">
            ...
            {/* Call to Action */}
            <AnimatedSection animation="slideInRight" delay={500}>
              <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg p-8 text-center text-white hover-lift">
          ...
          <div className="space-y-6">
              ...
              <AnimatedSection animation="slideInRight" delay={400}>
                <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button className="flex items-center justify-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors transform hover:scale-105">
                      <ShareIcon className="w-4 h-4" />
                      Facebook
                    </button>
                    <button className="flex items-center justify-center gap-2 bg-blue-400 text-white px-4 py-2 rounded-lg hover:bg-blue-500 transition-colors transform hover:scale-105">
                      <ShareIcon className="w-4 h-4" />
                      Twitter
                    </button>
                    <button className="flex items-center justify-center gap-2 bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-colors transform hover:scale-105">
                      <ShareIcon className="w-4 h-4" />
                      WhatsApp
                    </button>
                    <button className="flex items-center justify-center gap-2 bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-700 transition-colors transform hover:scale-105">
                      <ShareIcon className="w-4 h-4" />
                      Email
                    </button>
                  </div>
            ...
            <AnimatedSection animation="slideInRight" delay={500}>
              <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                ...
                <div className="space-y-3">
                  <button className="w-full flex items-center justify-center gap-2 bg-yellow-500 text-gray-900 px-4 py-2 rounded-lg hover:bg-yellow-600 transition-colors transform hover:scale-105">
                    <BookmarkIcon className="w-4 h-4" />
                    Save for Later
                  </button>
                  <button className="w-full flex items-center justify-center gap-2 bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-600 transition-colors transform hover:scale-105">
                    <HeartIcon className="w-4 h-4" />
                    Like Story
                  </button>
                  <button className="w-full flex items-center justify-center gap-2 bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition-colors transform hover:scale-105">
              ...
              <AnimatedSection animation="slideInRight" delay={600}>
                <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-700">
                  ...
                  <StaggeredList className="space-y-4">
                    <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors cursor-pointer hover-lift">
