...
export async function getDb() {
  ...
  try {
    ...
    const options = {
      ...
      heartbeatFrequencyMS: 30000, // Increased to reduce connection churn
      retryWrites: true,
      retryReads: true,
      w: 'majority',
      ...
      maxIdleTimeMS: 60000, // Increased to keep connections alive longer
      waitQueueTimeoutMS: 10000, // Increased for better reliability
