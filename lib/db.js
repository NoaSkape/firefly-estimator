...
export async function getDb() {
  ...
  try {
    ...
    const options = {
      ...
      ssl: true,
      sslValidate: true,
      sslCA: undefined, // Let MongoDB driver handle CA certificates
      authSource: 'admin',
      // Compression
    ...
    // Add additional TLS settings for Atlas with better error handling
    if (uri.includes('mongodb+srv') || uri.includes('mongodb.net')) {
      // For Atlas, use enhanced TLS configuration
      options.tls = true;
