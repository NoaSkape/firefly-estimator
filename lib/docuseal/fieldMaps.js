...
export const FIELD_MAPS = {
  ...
  masterRetail: {
    ...
    // Section Initials (per spec)
    pa_c_initials: { role: 'buyer', readonly: false, type: 'initials' },
    pa_f_initials: { role: 'buyer', readonly: false, type: 'initials' },
    pa_g_initials: { role: 'buyer', readonly: false, type: 'initials' },
    pa_h_initials: { role: 'buyer', readonly: false, type: 'initials' },
    pa_m_initials: { role: 'buyer', readonly: false, type: 'initials' },
    pa_k_initials: { role: 'buyer', readonly: false, type: 'initials' },
