...
<div class="section">
  <div class="model-specs">
    ...
    <div class="info-line">
      ...
      <span class="value">${order.model?.brand || ''}</span>
    </div>
    <div class="info-line">
      <span class="label">Model:</span>
      <span class="value">${order.model?.model || ''}</span>
    </div>
    <div class="info-line">
      <span class="label">Year:</span>
      <span class="value">${order.model?.year || ''}</span>
    </div>
    <div class="info-line">
      <span class="label">Dimensions:</span>
      <span class="value">${order.model?.dimensions || ''}</span>
    </div>
  </div>
</div>
...
<div class="section">
  <div class="payment-info">
    ...
    <div class="info-line">
      ...
      <span class="value">${order.paymentMethod === 'cash_ach' ? 'Bank Transfer (ACH/Wire)' : 
                            order.paymentMethod === 'credit_card' ? 'Credit Card' : 
                            order.paymentMethod === 'financing' ? 'Financing' : 'Cash'}</span>
    </div>
