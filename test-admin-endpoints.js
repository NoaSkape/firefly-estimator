...
async function runTests() {
  ...
  await testEndpoint('/api/admin/users/detailed')
  await testEndpoint('/api/admin/orders/paid')
  await testEndpoint('/api/admin/financial/revenue')
  await testEndpoint('/api/admin/builds/active')
  await testEndpoint('/api/admin/blog')
  await testEndpoint('/api/admin/drafts')
  await testEndpoint('/api/admin/policies')
